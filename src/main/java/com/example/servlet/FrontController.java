...
public class FrontController extends HttpServlet {
	...
	private static final String BACK_LOGIN_ACTION = "BackLogin";
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) {
		...
		if ( !action.equalsIgnoreCase(LOGIN_ACTION) && !action.equalsIgnoreCase(REGISTER_ACTION) && !action.equalsIgnoreCase(REGISTER_USER_ACTION) && !action.equalsIgnoreCase(BACK_LOGIN_ACTION) ){
